...
function ContactOwner() {
  ...
  const submitQueryData = async () => {
    try {
      ...
      if (response.ok && result.success) {
        ...
        window.location.replace("http://localhost:3000/submitquery");
      } else {
  ...
  const fetchOwnersDetails = async (id) => {
    console.log("Hello");
    try {
          ...
          <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
            ...
            <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
              ...
              <p class="mb-8 leading-relaxed">
                <h4>
                  <span className="font-bold">Contact At :- </span>
                  {ownerDetails.contact}{" "}
                </h4>
                <h4>
                  <span className="font-bold">Drop Email at :- </span>
                  {ownerDetails.email}{" "}
                </h4>
                <h4>
                  <span className="font-bold">Available between :- </span>
                  {ownerDetails.availability}{" "}
                </h4>
              </p>
              <div class="flex w-full md:justify-start justify-center items-end">
                <div class="relative mr-4 lg:w-full xl:w-1/2 w-2/4">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setQuery({ ...querydata, query: e.target.value })
                    }
                    type="text"
                    id="hero-field"
                    name="hero-field"
