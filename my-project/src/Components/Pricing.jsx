      ...
      <section class="text-gray-600 body-font overflow-hidden ">
        <div class="container px-5 py-24 mx-auto">
          <div class="flex flex-col text-center w-full mb-20">
            ...
            <p class="mx-auto leading-relaxed text-base text-gray-500">
              Let the World Serve You !!
            </p>
          ...
          <div class="flex flex-wrap -m-4">
            <div class="p-4 ml-[12rem] xl:w-1/4 md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
                ...
                <p class="flex items-center text-gray-600 mb-2">
                  ...
                  Get Access to the list of hostels
                </p>
                <p class="flex items-center text-gray-600 mb-2">
                  <span class="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
                    <svg
                ...
                <p class="text-xs text-gray-500 mt-3">
                  Literally you probably haven't explored of them.
                </p>
              </div>
            </div>
            <div class="p-4 xl:w-1/4 ml-[14rem] md:w-1/2 w-full">
              <div class="h-full p-6 rounded-lg border-2 border-indigo-500 flex flex-col relative overflow-hidden">
                ...
                <p class="flex items-center text-gray-600 mb-2">
                 ...
                 Free Home delivery for the food items
                </p>
                <p class="flex items-center text-gray-600 mb-2">
                  <span class="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
                    <svg
                  ...
                  View the complete menu of the Hostels/Mess for 1 month
                </p>
                <p class="flex items-center text-gray-600 mb-2">
                  <span class="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
                    <svg
                  ...
                  Let our AI decide the best for you
                </p>
                <p class="flex items-center text-gray-600 mb-6">
                  <span class="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
                    <svg
                  ...
                  Get access to 100 images of the hostels
                </p>
                ...
                <p class="text-xs text-gray-500 mt-3">
                  Literally you probably haven't heard of them, do Explore !!!.
                </p>
              </div>
            </div>
          </div>
